...
# title = "{}".format(
#     d.get("title", os.path.basename(os.path.splitext(d.get("file", "Untitled"))[0]))
# )
...
tags = MP3(d.get("file")).tags
title = tags.get("TIT2")[0]
display = "{}\n{}\n{}".format(tags.get("TPE1"), tags.get("TALB"), tags.get("TDOR"))
...
try:
    ...
    try:
        ...
        fallback_image_path = "/home/d0np0br3/Music/cover.png"
...
# n.show()
# n.uninit()
call(["dunstify", "-r", "1996", "-i", temp_image, title, display])
# sys.exit()
# main.run()
